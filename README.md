...
Cursor IDE
Extensions: Claude Code and Codex
Gitbub Desktop

Steps you completed:
Installed Cursor IDE and created an account.
Also connected github account
Installed and authorized github account to cursor
Allowed public and private network to access the app
Went to Github and created a repository
Gave name to the repo and enabled "Add README" option
